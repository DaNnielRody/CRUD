...
form.addEventListener('submit', async (evento) => { // como o event listener já dá um parâmetro de evento para acionar como alvo, não precisa procurar o data pelo document, mas pelo próprio evento.target
